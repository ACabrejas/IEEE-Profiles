...
\author{Alvaro Cabrejas Egea$^{1}$, Peter de Ford$^{2}$ and Colm Connaughton$^{3}$% <-this % stops a space
...
A. C. E. thanks Stefan Grosskinsky for the initial guidance, discussions and support.}% <-this % stops a space
...
\begin{figure}[htbp]
	...
	\caption{M6 travel times (seconds), link 117007401, over three weeks.}
