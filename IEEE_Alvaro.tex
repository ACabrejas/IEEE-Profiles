...
We use 8 weeks of training data and calculate the mean absolute percentage error of the resulting travel time estimates for week of test data, repeating this process 4 times. 
