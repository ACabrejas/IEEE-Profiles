...
For each link on a specific date, the required data consists of one entry per minute, containing:
\begin{itemize}
...
In the case of the M6 and M11, the data comprises 12 complete weeks of travel time. The previous 8 weeks are used to predict one week ahead.
